...
(() => {
  ...
  const COPY = new Map([
    ...
    ['Créez un lien de suivi vers une page ARTY. La destination choisit la page à ouvrir; le nom de campagne sert seulement à reconnaître les résultats dans vos statistiques.','Create a trackable link to an ARTY page. The destination controls which page opens; the campaign name is only used to identify results in your reporting.'],
    ['Plateforme / source','Platform / source'],
    ['Type de trafic','Traffic type'],
    ['Nom de campagne (suivi interne)','Campaign name (internal tracking)'],
    ['Le nom de campagne ne change jamais la page de destination. Il sert uniquement à identifier la campagne dans les statistiques.','The campaign name never changes the destination page. It is only used to identify the campaign in reporting.'],
    ['Tester le lien','Test link'],
