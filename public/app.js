...
async function addDesignStudioToCart(goCheckout=false){
  ...
  try{
    ...
    clearDesignStudioDraft();saveCart();updateCartUI();showToast(I18n.msg`${isBag?I18n.t('Sac'):I18n.t('Toile')} personnalisé${isBag?'':'e'} ajouté${isBag?'':'e'} au panier`,'success');if(goCheckout)setTimeout(()=>goToCheckout(),250);else openCart();
