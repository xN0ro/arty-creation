...
function renderDesignStudioPage(){
  ...
  container.innerHTML=`<div class="design-studio-app">
    <header class="design-studio-topbar">
      <div class="design-studio-brand"><button type="button" class="design-studio-exit" onclick="exitDesignStudio()" aria-label="Quitter le studio">${designStudioIcon('back')}<span>Quitter</span></button><i aria-hidden="true"></i><img src="logoarty.png" alt="ARTY"><span><strong>Studio de création</strong><small>Votre design, prêt à peindre</small></span></div>
...
function exitDesignStudio(){navigate('#/paintings')}
...
window.addEventListener('resize',()=>{if((window.location.hash||'')==='#/studio')requestAnimationFrame(()=>fitDesignStudioCanvas())});
