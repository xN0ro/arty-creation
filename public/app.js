...
function renderProfileOrders(){
  ...
  if(!profileOrders.length){wrap.innerHTML=I18n.html`<div class="account-empty">${profileIcon('orders')}<h3>Aucune commande pour le moment</h3><p>Vos prochaines commandes apparaîtront ici avec leur suivi.</p><button class="btn btn-orange" onclick="navigate('#/paintings')">Découvrir les kits</button></div>`;return}
